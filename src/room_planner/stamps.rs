...
pub fn core_stamp() -> RoomMatrixSlice<PlannedTile> {
    ...
    result.set((1, 0).try_into().unwrap(), PlannedTile::from(Road).with_min_rcl(MIN_MIN_ROAD_RCL));
    result.set((2, 0).try_into().unwrap(), PlannedTile::from(Road).with_min_rcl(MIN_MIN_ROAD_RCL));
    result.set((3, 0).try_into().unwrap(), PlannedTile::from(Road).with_min_rcl(MIN_MIN_ROAD_RCL));
    result.set((4, 0).try_into().unwrap(), PlannedTile::from(Road).with_min_rcl(MIN_MIN_ROAD_RCL));
    result.set((5, 0).try_into().unwrap(), PlannedTile::from(Road).with_min_rcl(MIN_MIN_ROAD_RCL));

    result.set((0, 1).try_into().unwrap(), PlannedTile::from(Road).with_min_rcl(MIN_MIN_ROAD_RCL));
    ...
    result.set((6, 1).try_into().unwrap(), PlannedTile::from(Road).with_min_rcl(MIN_MIN_ROAD_RCL));
    ...
    result.set((6, 3).try_into().unwrap(), PlannedTile::from(Road).with_min_rcl(MIN_MIN_ROAD_RCL));

    result.set((0, 4).try_into().unwrap(), PlannedTile::from(Road).with_min_rcl(MIN_MIN_ROAD_RCL));
    ...
    result.set((6, 4).try_into().unwrap(), PlannedTile::from(Road).with_min_rcl(MIN_MIN_ROAD_RCL));

    result.set((0, 5).try_into().unwrap(), PlannedTile::from(Road).with_min_rcl(MIN_MIN_ROAD_RCL));
    ...
    result.set((6, 5).try_into().unwrap(), PlannedTile::from(Road).with_min_rcl(MIN_MIN_ROAD_RCL));

    result.set((1, 6).try_into().unwrap(), PlannedTile::from(Road).with_min_rcl(MIN_MIN_ROAD_RCL));
    result.set((2, 6).try_into().unwrap(), PlannedTile::from(Road).with_min_rcl(MIN_MIN_ROAD_RCL));
    result.set((3, 6).try_into().unwrap(), PlannedTile::from(Road).with_min_rcl(MIN_MIN_ROAD_RCL));
    result.set((4, 6).try_into().unwrap(), PlannedTile::from(Road).with_min_rcl(MIN_MIN_ROAD_RCL));
    result.set((5, 6).try_into().unwrap(), PlannedTile::from(Road).with_min_rcl(MIN_MIN_ROAD_RCL));
